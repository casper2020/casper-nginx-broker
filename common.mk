...
CASPER_NGINX_BROKER_CDN_COMMON_MODULES_DEP_ON?=false
CASPER_NGINX_BROKER_CDN_ARCHIVE_MODULES_DEP_ON?=false
...
update-sources:
	...
	@$(eval BROKER_CC_SRC+=$(shell if [ true = $(CASPER_NGINX_BROKER_CDN_COMMON_MODULES_DEP_ON) ] ; then \
		echo "$(BROKER_CDN_COMMON_MODULE_CC_SRC) $(BROKER_CDN_MODULE_CC_SRC) $(BROKER_CDN_DOWNLOAD_MODULE_CC_SRC)" ; \
		fi \
	))
	...
	@$(eval BROKER_YY_SRC+=$(shell if [ true = $(CASPER_NGINX_BROKER_CDN_COMMON_MODULES_DEP_ON) ] ; then echo "$(BROKER_CDN_COMMON_MODULE_YY_SRC)" ; fi))
	@$(eval BROKER_RL_SRC+=$(shell if [ true = $(CASPER_NGINX_BROKER_CDN_COMMON_MODULES_DEP_ON) ] ; then echo "$(BROKER_CDN_COMMON_MODULE_RL_SRC)" ; fi))
