...
extern ngx_int_t    ngx_http_casper_broker_cdn_module_content_handler (ngx_http_request_t* a_r);
extern ngx_int_t    ngx_http_casper_broker_cdn_module_rewrite_handler (ngx_http_request_t* a_r);
