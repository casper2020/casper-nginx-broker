/**
 * @file ngx_http_casper_broker_cdn_download_module.cc
 *
...
#include "ngx/casper/broker/cdn-download/module/ngx_http_casper_broker_cdn_download_module.h"
...
static void*     ngx_http_casper_broker_cdn_download_module_create_loc_conf (ngx_conf_t* a_cf);
 ...
 */
static ngx_command_t ngx_http_casper_broker_cdn_download_module_commands[] = {
    {
        ngx_string("nginx_casper_broker_cdn_download"),                                   /* directive name */
    ...
    /* log proposes */
    {
        ...
        offsetof(ngx_http_casper_broker_cdn_download_module_loc_conf_t, log_token),
        NULL
    },
    /* closure */
    ngx_null_command
...
/**
 * @brief The casper-nginx-broker 'cdn' module context setup data.
 */
static ngx_http_module_t ngx_http_casper_broker_cdn_download_module_ctx = {
    NULL,                                                        /* preconfiguration              */
    ngx_http_casper_broker_cdn_download_module_filter_init,      /* postconfiguration             */
    NULL,                                                        /* create main configuration     */
    NULL,                                                        /* init main configuration       */
    NULL,                                                        /* create server configuration   */
    NULL,                                                        /* merge server configuration    */
    ngx_http_casper_broker_cdn_download_module_create_loc_conf,  /* create location configuration */
    ngx_http_casper_broker_cdn_download_module_merge_loc_conf    /* merge location configuration  */
};

/**
 * @brief The casper-nginx-broker 'cdn' module setup data.
 */
ngx_module_t ngx_http_casper_broker_cdn_download_module = {
    NGX_MODULE_V1,
    &ngx_http_casper_broker_cdn_download_module_ctx,     /* module context    */
    ngx_http_casper_broker_cdn_download_module_commands, /* module directives */
...
static void* ngx_http_casper_broker_cdn_download_module_create_loc_conf (ngx_conf_t* a_cf)
{
    ngx_http_casper_broker_cdn_download_module_loc_conf_t* conf =
        (ngx_http_casper_broker_cdn_download_module_loc_conf_t*) ngx_pcalloc(a_cf->pool, sizeof(ngx_http_casper_broker_cdn_download_module_loc_conf_t));
    if ( NULL == conf ) {
...
static char* ngx_http_casper_broker_cdn_download_module_merge_loc_conf (ngx_conf_t* a_cf, void* a_parent, void* a_child)
{
    ngx_http_casper_broker_cdn_download_module_loc_conf_t* prev = (ngx_http_casper_broker_cdn_download_module_loc_conf_t*) a_parent;
    ngx_http_casper_broker_cdn_download_module_loc_conf_t* conf = (ngx_http_casper_broker_cdn_download_module_loc_conf_t*) a_child;

    ngx_conf_merge_value    (conf->enable           , prev->enable           ,                     0 ); /* 0 - disabled */
    ngx_conf_merge_str_value(conf->log_token        , prev->log_token        , "cdn_download_module" );
...
static ngx_int_t ngx_http_casper_broker_cdn_download_module_filter_init (ngx_conf_t* a_cf)
{
     ...
     */
    const ngx_int_t rv = NGX_BROKER_MODULE_INSTALL_REWRITE_HANDLER(ngx_http_casper_broker_cdn_download_module_rewrite_handler);
    if ( NGX_OK != rv ) {
        return rv;
    }
     ...
     */
    return NGX_BROKER_MODULE_INSTALL_CONTENT_HANDLER(ngx_http_casper_broker_cdn_download_module_content_handler);
}
...
ngx_int_t ngx_http_casper_broker_cdn_download_module_content_handler (ngx_http_request_t* a_r)
{
     ...
     */   
    NGX_BROKER_MODULE_CONTENT_HANDLER_BARRIER(a_r, ngx_http_casper_broker_cdn_download_module, ngx_http_casper_broker_cdn_download_module_loc_conf_t,
                                              "cdn_download_module");
    /*
     * This module is enabled.
     */    
    ngx::casper::broker::cdn::dl::Module* module = (ngx::casper::broker::cdn::dl::Module*) ngx_http_get_module_ctx(a_r, ngx_http_casper_broker_cdn_download_module);
    if ( nullptr == module ) {
        // ... wtf?
        return NGX_ERROR;
    }
...
ngx_int_t ngx_http_casper_broker_cdn_download_module_rewrite_handler (ngx_http_request_t* a_r)
{
     ...
     * Check if module is enabled and the request can be handled here.
     */
    NGX_BROKER_MODULE_REWRITE_HANDLER_BARRIER(a_r, ngx_http_casper_broker_cdn_download_module, ngx_http_casper_broker_cdn_download_module_loc_conf_t,
                                              "cdn_download_module");
    
    const auto tackle_response = [] (ngx_http_request_t* a_r, ngx::casper::broker::cdn::dl::Module* a_module) -> ngx_int_t {
        //
        if ( true == a_module->SynchronousResponse() ) {
            // ... synchronous response ...
            if ( true == a_module->InternalRedirect() ) {
                NGX_BROKER_MODULE_DEBUG_LOG(ngx_http_casper_broker_cdn_download_module, a_r, "cdn_download_module",
                                            "RW", "LEAVING",
    ...
    if ( nullptr == module ) {
        ...
        rv = ngx::casper::broker::cdn::dl::Module::Factory(a_r, /* a_at_rewrite_handler */true);
        if ( NGX_OK == rv ) {
            rv = tackle_response(a_r, (ngx::casper::broker::cdn::dl::Module*) ngx_http_get_module_ctx(a_r, ngx_http_casper_broker_cdn_download_module));
        } else if ( NGX_DONE == rv ) {
