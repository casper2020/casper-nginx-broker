...
static ngx_int_t ngx_http_casper_broker_cdn_public_module_content_handler (ngx_http_request_t* a_r);
static ngx_int_t ngx_http_casper_broker_cdn_public_module_rewrite_handler (ngx_http_request_t* a_r);
...
static char* ngx_http_casper_broker_cdn_public_module_merge_loc_conf (ngx_conf_t* a_cf, void* a_parent, void* a_child)
{
    ...
    ngx_conf_merge_str_value (conf->log_token, prev->log_token, "cdn_public_module");
