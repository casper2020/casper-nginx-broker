/**
 * @file ngx_http_casper_broker_cdn_api_module.h
 *
...
#pragma once
#ifndef NRS_NGX_HTTP_CASPER_BROKER_CDN_API_MODULE_H_
#define NRS_NGX_HTTP_CASPER_BROKER_CDN_API_MODULE_H_
...
typedef struct {
    ...
    ngx_uint_t validity; //!<
    ngx_str_t  slaves;   //!<
} ngx_http_casper_broker_cdn_api_module_sideline_t;

typedef struct {
    ngx_flag_t                                       enable;           //!< flag that enables the module
    ngx_str_t                                        log_token;        //!<
    ngx_str_t                                        directory_prefix; //!<
    ngx_http_casper_broker_cdn_api_module_sideline_t sideline;         //!<
