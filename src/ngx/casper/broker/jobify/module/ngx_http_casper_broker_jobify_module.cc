/**
 * @file ngx_http_casper_broker_jobify_module.cc
 *
...
#include "ngx/casper/broker/jobify/module/ngx_http_casper_broker_jobify_module.h"
 ...
 */
static ngx_command_t ngx_http_casper_broker_jobify_module_commands[] = {
    {
        ngx_string("nginx_casper_broker_jobify"),                       /* directive name */
        ...
        offsetof(ngx_http_casper_broker_jobify_module_loc_conf_t, enable), /* ... on the 'enable' element */
        NULL
    },
    {
        ngx_string("nginx_casper_broker_jobify_log_token"),
        NGX_HTTP_MAIN_CONF | NGX_CONF_TAKE1,
        ngx_conf_set_str_slot,
        NGX_HTTP_LOC_CONF_OFFSET,
        offsetof(ngx_http_casper_broker_jobify_module_loc_conf_t, log_token),
        NULL
    },
    ngx_null_command
};
...
/**
 * @brief The casper-nginx-broker 'jobify' module context setup data.
 */
static ngx_http_module_t ngx_http_casper_broker_jobify_module_ctx = {
    NULL,                                               /* preconfiguration              */
    ngx_http_casper_broker_jobify_module_filter_init,      /* postconfiguration             */
    NULL,                                               /* create main configuration     */
    NULL,                                               /* init main configuration       */
    NULL,                                               /* create server configuration   */
    NULL,                                               /* merge server configuration    */
    ngx_http_casper_broker_jobify_module_create_loc_conf,  /* create location configuration */
    ngx_http_casper_broker_jobify_module_merge_loc_conf    /* merge location configuration  */
};

/**
 * @brief The casper-nginx-broker 'jobify' module setup data.
 */
ngx_module_t ngx_http_casper_broker_jobify_module = {
    NGX_MODULE_V1,
    &ngx_http_casper_broker_jobify_module_ctx,     /* module context    */
    ngx_http_casper_broker_jobify_module_commands, /* module directives */
...
static void* ngx_http_casper_broker_jobify_module_create_loc_conf (ngx_conf_t* a_cf)
{
    ngx_http_casper_broker_jobify_module_loc_conf_t* conf =
        (ngx_http_casper_broker_jobify_module_loc_conf_t*) ngx_pcalloc(a_cf->pool, sizeof(ngx_http_casper_broker_jobify_module_loc_conf_t));
    if ( NULL == conf ) {
...
static char* ngx_http_casper_broker_jobify_module_merge_loc_conf (ngx_conf_t* a_cf, void* a_parent, void* a_child)
{
    ngx_http_casper_broker_jobify_module_loc_conf_t* prev = (ngx_http_casper_broker_jobify_module_loc_conf_t*) a_parent;
    ngx_http_casper_broker_jobify_module_loc_conf_t* conf = (ngx_http_casper_broker_jobify_module_loc_conf_t*) a_child;

    ngx_conf_merge_value     (conf->enable      , prev->enable      ,              0 ); /* 0 - disabled */
    ngx_conf_merge_str_value (conf->log_token   , prev->log_token   , "jobify_module");
