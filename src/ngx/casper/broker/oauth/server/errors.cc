 ...
 * @param a_locale
 */
ngx::casper::broker::oauth::server::Errors::Errors (const std::string& a_locale, bool a_enable_nice_piece_of_code_a_k_a_ordered_json)
 ...
 * @brief Destructor.
 */
ngx::casper::broker::oauth::server::Errors::~Errors ()
{
    /* empty */
}
