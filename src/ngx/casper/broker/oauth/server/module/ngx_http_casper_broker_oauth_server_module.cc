/**
 * @file ngx_http_casper_broker_oauth_server_module.cc
 *
 ...
 */
static ngx_command_t ngx_http_casper_broker_oauth_server_module_commands[] = {
    {
        ngx_string("nginx_casper_broker_oauth_server"),                          /* directive name */
        ...
        offsetof(ngx_http_casper_broker_oauth_server_module_loc_conf_t, enable), /* ... on the 'enable' element */
        NULL
    },
    {
        ngx_string("nginx_casper_broker_oauth_server_log_token"),
...
/**
 * @brief The casper-nginx-broker 'oauth server' module context setup data.
 */
static ngx_http_module_t ngx_http_casper_broker_oauth_server_module_ctx = {
    NULL,                                                        /* preconfiguration              */
    ngx_http_casper_broker_oauth_server_module_filter_init,      /* postconfiguration             */
    NULL,                                                        /* create main configuration     */
    NULL,                                                        /* init main configuration       */
    NULL,                                                        /* create server configuration   */
    NULL,                                                        /* merge server configuration    */
    ngx_http_casper_broker_oauth_server_module_create_loc_conf,  /* create location configuration */
    ngx_http_casper_broker_oauth_server_module_merge_loc_conf    /* merge location configuration  */
};

/**
 * @brief The casper-nginx-broker 'oauth server' module setup data.
 */
ngx_module_t ngx_http_casper_broker_oauth_server_module = {
    NGX_MODULE_V1,
    &ngx_http_casper_broker_oauth_server_module_ctx,     /* module context    */
    ngx_http_casper_broker_oauth_server_module_commands, /* module directives */
...
static void* ngx_http_casper_broker_oauth_server_module_create_loc_conf (ngx_conf_t* a_cf)
{
    ngx_http_casper_broker_oauth_server_module_loc_conf_t* conf =
        (ngx_http_casper_broker_oauth_server_module_loc_conf_t*) ngx_pcalloc(a_cf->pool, sizeof(ngx_http_casper_broker_oauth_server_module_loc_conf_t));
    if ( NULL == conf ) {
