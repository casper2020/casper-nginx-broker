/**
 * @file ngx_http_casper_broker_api_module.cc
 *
...
static void*     ngx_http_casper_broker_api_module_create_loc_conf (ngx_conf_t* a_cf);
 ...
 */
static ngx_command_t ngx_http_casper_broker_api_module_commands[] = {
    {
        ngx_string("nginx_casper_broker_api"),                          /* directive name */
        ...
        offsetof(ngx_http_casper_broker_api_module_loc_conf_t, enable), /* ... on the 'enable' element */
        NULL
    },
    {
        ngx_string("nginx_casper_broker_api_log_token"),
        NGX_HTTP_MAIN_CONF | NGX_CONF_TAKE1,
        ngx_conf_set_str_slot,
        NGX_HTTP_LOC_CONF_OFFSET,
        offsetof(ngx_http_casper_broker_api_module_loc_conf_t, log_token),
        NULL
    },
    {
        ngx_string("nginx_casper_broker_json_api_url"),
        NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
        ngx_conf_set_str_slot,
        NGX_HTTP_LOC_CONF_OFFSET,
        offsetof(ngx_http_casper_broker_api_module_loc_conf_t, json_api_url),
        NULL
    },
    ngx_null_command
};
...
/**
 * @brief The casper-nginx-broker 'api' module context setup data.
 */
static ngx_http_module_t ngx_http_casper_broker_api_module_ctx = {
    NULL,                                               /* preconfiguration              */
    ngx_http_casper_broker_api_module_filter_init,      /* postconfiguration             */
    NULL,                                               /* create main configuration     */
    NULL,                                               /* init main configuration       */
    NULL,                                               /* create server configuration   */
    NULL,                                               /* merge server configuration    */
    ngx_http_casper_broker_api_module_create_loc_conf,  /* create location configuration */
    ngx_http_casper_broker_api_module_merge_loc_conf    /* merge location configuration  */
};

/**
 * @brief The casper-nginx-broker 'api' module setup data.
 */
ngx_module_t ngx_http_casper_broker_api_module = {
    NGX_MODULE_V1,
    &ngx_http_casper_broker_api_module_ctx,     /* module context    */
    ngx_http_casper_broker_api_module_commands, /* module directives */
...
static void* ngx_http_casper_broker_api_module_create_loc_conf (ngx_conf_t* a_cf)
{
    ngx_http_casper_broker_api_module_loc_conf_t* conf =
        (ngx_http_casper_broker_api_module_loc_conf_t*) ngx_pcalloc(a_cf->pool, sizeof(ngx_http_casper_broker_api_module_loc_conf_t));
    if ( NULL == conf ) {
    ...
    conf->json_api_url = ngx_null_string;
...
static char* ngx_http_casper_broker_api_module_merge_loc_conf (ngx_conf_t* a_cf, void* a_parent, void* a_child)
{
    ...
    ngx_conf_merge_str_value (conf->log_token   , prev->log_token   , "api_module");
...
static ngx_int_t ngx_http_casper_broker_api_module_filter_init (ngx_conf_t* a_cf)
{
     ...
     */
    return NGX_BROKER_MODULE_INSTALL_CONTENT_HANDLER(ngx_http_casper_broker_api_module_content_handler);
}
